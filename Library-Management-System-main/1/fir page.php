  ...
  <ul class="dropdown-menu" id="1">
   ...
   <div class="text-box" style="background-color:yellow" >
    <section class="col-sm-6" class="section1" style="height:517px;font-size:30px;color:#FFD700" >
      ...
      <a href="fir form.html" style="margin:100px;padding:7px;border-bottom: 2px solid #FFD700;">FIR Form</a><br>
      <a href="fir status.html" style="margin:100px;padding:7px;border-bottom: 2px solid #FFD700;">FIR status</a><br>
